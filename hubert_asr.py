...
class HubertEncoder(FairseqEncoder): #ctc用的
...
class HubertEncoderWrapper(FairseqEncoder):
    ...
    def forward(self, source, padding_mask, **kwargs):
        ...
        x, padding_mask = self.w2v_model.extract_finetune_shift(**w2v_args) # 
        # B x T x C -> T x B x C
        x = x.transpose(0, 1)
...
class AVHubertSeq2Seq(FairseqEncoderDecoderModel):
    ...
    def extract_alignment(
        ...
        return self.encoder.w2v_model.extract_alignment(source)
