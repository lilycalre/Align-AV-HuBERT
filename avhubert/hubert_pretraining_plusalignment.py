...
@dataclass
class AVHubertPretrainingConfigPlusAlignment(FairseqDataclass):
    data: str = field(
    ...
    max_shift_num: float = field(
        default=1.0, metadata={"help": "max_shift_num"})
    shift_time: int = field(
        default=10, metadata={"help": "shift_time"})
    
@register_task("av_hubert_pretraining_plusalignment", dataclass=AVHubertPretrainingConfigPlusAlignment)
class AVHubertPretrainingTaskPlusAlignment(FairseqTask):

    cfg: AVHubertPretrainingConfigPlusAlignment
    ...
    @classmethod
    def setup_task(
        cls, cfg: AVHubertPretrainingConfigPlusAlignment, **kwargs
