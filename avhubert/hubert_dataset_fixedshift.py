...
def load_audio_visual(manifest_path, max_keep, min_keep, frame_rate, label_paths, label_rates,tol=0.1,shift_num_fixed=0):
...
class AVHubertDataset(FairseqDataset):
    def __init__(
        ...
        self.audio_root, self.names, inds, tot, self.sizes, self.shifts = load_audio_visual(manifest_path, max_keep_sample_size, min_keep_sample_size, frame_rate=sample_rate, label_paths=label_paths, label_rates=self.label_rates,shift_num_fixed=shift_num_fixed)
